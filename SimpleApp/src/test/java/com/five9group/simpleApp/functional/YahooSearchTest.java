...
public class YahooSearchTest {
	...
	private String expectedTitle2 ="################ - Yahoo Search Results";
	...
	@Test
	public void shouldBeAbleToSerarch2() 
	{
		 driver.findElement(By.xpath(".//*[@id='uh-search-box']")).sendKeys("################");
         driver.findElement(By.xpath(".//*[@id='uh-search-button']")).click();
		// verify title of index page
         String actualTitle = driver.getTitle();
         assertThat(actualTitle, equalTo(expectedTitle2));
